...
if __name__ == "__main__":
    ...
    if on_colab:
        # NH-Haze
        # def_orig = "/content/drive/MyDrive/AOD_NET (Project)/baseline/nh-haze-clean-images"
        # def_hazy = "/content/drive/MyDrive/AOD_NET (Project)/baseline/nh-haze-hazy-images"
        # NYU2
